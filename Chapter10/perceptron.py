...
if __name__ == '__main__':
    ...
    ax.scatter(X[Y == 0, 0], X[Y == 0, 1], marker='o', s=100, label="Class 0")
    ...
    ax.scatter(X[Y_pred_perceptron == 0, 0], X[Y_pred_perceptron == 0, 1], marker='o', s=100, label="Class 0")
    ax.scatter(X[Y_pred_perceptron == 1, 0], X[Y_pred_perceptron == 1, 1], marker='s', s=100, label="Class 1")
    ax.set_xlabel(r'$x_0$', fontsize=22)
    ax.set_ylabel(r'$x_1$', fontsize=22)
    ax.grid(True)
    ax.legend(fontsize=20)
